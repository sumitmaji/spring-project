...
public class EmpDetailsViewId  implements java.io.Serializable {
    ...
    public EmpDetailsViewId(int employeeId, String jobId, Integer managerId, Short departmentId, Short locationId, String countryId, String firstName, String lastName, BigDecimal salary, BigDecimal commissionPct, String departmentName, String jobTitle, String city, String stateProvince, String countryName, String regionName) {
       this.employeeId = employeeId;
       this.jobId = jobId;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof EmpDetailsViewId) ) return false;
 ...
 && ( (this.getCountryId()==castOther.getCountryId()) || ( this.getCountryId()!=null && castOther.getCountryId()!=null && this.getCountryId().equals(castOther.getCountryId()) ) )
 ...
 && ( (this.getCommissionPct()==castOther.getCommissionPct()) || ( this.getCommissionPct()!=null && castOther.getCommissionPct()!=null && this.getCommissionPct().equals(castOther.getCommissionPct()) ) )
 ...
 && ( (this.getStateProvince()==castOther.getStateProvince()) || ( this.getStateProvince()!=null && castOther.getStateProvince()!=null && this.getStateProvince().equals(castOther.getStateProvince()) ) )
